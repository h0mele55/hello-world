...
| [`docs/09-automated-verifier.md`](docs/09-automated-verifier.md) | AVA, the automated verifier agent: assurance classes (machine / human / co-attestation), policy-as-code rulesets, receipted + TEE-verifiable execution, transparency log — third-party-auditable attestation |
