...
| [`docs/08-inflect-integration.md`](docs/08-inflect-integration.md) | Worked integration plan: PoCA as a narrowing term in Inflect Compliance's agent-governance gate chain, evidence-bundle export, verifier portal, ZK track — with a 10-step implementation roadmap (agent prompts, context, tests, hardening per step) |
| [`docs/09-automated-verifier.md`](docs/09-automated-verifier.md) | AVA, the automated verifier agent: assurance classes (machine / judged / human / co-attestation), the Jev judgment layer with grill-me doctrine elicitation and a calibration-gated mode ladder, receipted + TEE-verifiable execution, transparency log — third-party-auditable attestation |
